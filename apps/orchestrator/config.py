...
class OrchestratorConfig:
    ...
    # Optional admin credentials for SCIM role fallback when token/userinfo
    # do not include role/group claims.
    is_admin_user: str | None = None
    is_admin_pass: str | None = None
    ...
    def from_env(
        ...
        is_browser_base_url = _validate_url(
            env.get("WSO2_IS_BROWSER_BASE_URL", "").strip() or is_base_url,
            "WSO2_IS_BROWSER_BASE_URL",
        )
        ...
        is_admin_user = env.get("IS_ADMIN_USER", "").strip() or None
        is_admin_pass = env.get("IS_ADMIN_PASS", "").strip() or None
        ...
        return cls(
            ...
            is_browser_base_url=is_browser_base_url,
